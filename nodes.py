...
Οδηγίες:
- Δημιούργησε 4-6 bullets.
- Καθε bullet να έχει περίπου μέγιστο αριθμό λέξεων 60.
...
-Φρόντισε κάθε πρόταση να έχει σωστή σύνταξη και συντακτική συνοχή και να είναι γραμματικά σωστή.
...
def improve_summary(state: State) -> dict:
    prompt = f"""
Αναλαμβάνεις τον ρόλο του επιμελητή των κύριων ιδεών/σημείων του άρθρου. Ο στόχος σου είναι να βελτιώσεις την αρχική εξαγωγή των κύριων ιδεών/σημείων του άρθρου (σε bullets), αξιοποιώντας τα σχόλια αξιολόγησης και το πλήρες κείμενο του άρθρου.
 
### Σκοπός:
Δημιούργησε μια τελική, συνοπτική, πλήρη και ακριβή εξαγωγή των κύριων ιδεών/σημείων.
...
- Καθε bullet να έχει περίπου μέγιστο αριθμό λέξεων 50.
...
Ενεργείς ως ειδικός στη τελική σύνοψη, συνδυασμό και επεξεργασία πληροφοριών. Ο ρόλος σου είναι να συνθέσεις την τελική, συνοπτική, πλήρη και ακριβή εξαγωγή των κύριων ιδεών/σημείων ενός ελληνικού άρθρου σε μορφή bullets, βασισμένος στα αποτελέσματα των λειτουργιών `generate_summary` και `improve_summary`.
 
Στόχος: Να συνδυάσεις τις πληροφορίες από τα δύο σύνολα από bullets, ώστε να προκύψει η πιο σαφής, πλήρης και ουσιαστική αποτύπωση των βασικών σημείων του άρθρου.
...
-Φρόντισε κάθε πρόταση να έχει σωστή σύνταξη και συντακτική συνοχή και να είναι γραμματικά σωστή.
- Απόφυγε **γενικότητες**, **πλεονασμούς**, **επαναλήψεις** ή **μη τεκμηριωμένες πληροφορίες**.
...
Μην προσθέτεις νέα δεδομένα. Εστίασε αποκλειστικά σε όσα προκύπτουν από δύο σύνολα από bullets που δέχεσαι στην είσοδο.
Άρθρο:
{state["article_text"]}
